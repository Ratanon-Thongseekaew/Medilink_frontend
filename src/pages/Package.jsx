            ...
            <div className="w-full py-6 max-w-7xl mx-auto">
                    <div className="flex flex-col lg:flex-row">
                        ...
                        <div className="lg:w-1/2 lg:pl-6 text-left">
                            ...
                            <button className="btn btn-primary text-lg py-6 px-6">ซื้อแพ็กเกจและโปรแกรม</button>
                            <div className="bg-gray-100 p-4 rounded-lg border mt-6 bg-white">
                                <h4 className="text-xl font-bold text-emerald-400 mb-2">นัดหมายเข้ารับบริการ</h4>

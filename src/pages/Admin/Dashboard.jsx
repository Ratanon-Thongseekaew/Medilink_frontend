...
function Dashboard() {
  return (
    ...
    <div className='flex flex-wrap ml-70 gap-30'>
      ...
      <div className="flex flex-col items-center justify-center border border-gray-600 w-60 h-60 rounded-xl mt-30 ">
      ...
      <div className="flex flex-col items-center justify-center border border-gray-600 w-60 h-60 rounded-xl">
